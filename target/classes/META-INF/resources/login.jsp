...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/static/ui/css/owl.theme.css">
...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        <div  class="message">尊敬会员，欢迎登录依力健身房</div>
        <div id="darkbannerwrap"></div>
        
        <form method="post" class="layui-form" action="${pageContext.request.contextPath}/menber/memberlogin">
        ...
        <center>
        <a  href="${pageContext.request.contextPath}/menber/register"  style="font-size: 20px;color: #1AA093;" >注册</a>
        </center>
    </div>
    <script>
